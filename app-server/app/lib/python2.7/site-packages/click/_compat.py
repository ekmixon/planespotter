...
if PY2:
    ...
    def get_text_stdin(encoding=None, errors=None):
        ...
        return rv if rv is not None else _make_text_stream(sys.stdin, encoding, errors)

    def get_text_stdout(encoding=None, errors=None):
        rv = _get_windows_console_stream(sys.stdout, encoding, errors)
        return _make_text_stream(sys.stdout, encoding, errors) if rv is None else rv

    def get_text_stderr(encoding=None, errors=None):
        rv = _get_windows_console_stream(sys.stderr, encoding, errors)
        return _make_text_stream(sys.stderr, encoding, errors) if rv is None else rv
