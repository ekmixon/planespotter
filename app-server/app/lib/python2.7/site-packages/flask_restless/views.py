...
def jsonpify(*args, **kw):
    ...
    if callback := request.args.get('callback', False):
...
class API(ModelView):
    ...
    def __init__(self, session, model, exclude_columns=None,
        ...
        *not* be present in the JSON representation of the model provided in
        ...
        self.serialize = self._inst_to_dict if serializer is None else serializer
        ...
        self.postprocessors |= upper_keys(postprocessors or {})
        self.preprocessors |= upper_keys(preprocessors or {})
    ...
    def _get_column_name(self, column):
        ...
        """
        if not hasattr(column, '__clause_element__'):
            return column
    ...
    def _instid_to_dict(self, instid):
        ...
        return ({_STATUS: 404}, 404) if inst is None else self._inst_to_dict(inst)
    ...
    def _search(self):
        ...
        for param in search_params.get('filters', []):
    ...
    def get(self, instid, relationname, relationinstid):
        ...
        if relationname is None:
            ...
            elif is_like_list(instance, relationname):
    ...
    def patch(self, instid, relationname, relationinstid):
        ...
        data = {field: data[field] for field in field_list}
